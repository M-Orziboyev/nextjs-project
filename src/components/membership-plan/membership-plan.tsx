...
import {MembershipPlanProps} from "./subscription-plan.props";
        ...
        <div
            ...
            <div className="space-y-2 py-4">
                ...
                <button onClick={openPortal}
                        className='h-10 w-full whitespace-nowrap bg-gray-300 py-2 text-sm font font-medium text-black shadow-md hover:bg-gray-200 md:w-4/5'>
            ...
            <div className="col-span-3 ">
                <div className="flex flex-col justify-between border-b border-white/10 py-4 md:flex-row">
                    ...
                    <div className='md:text-right'>
                        {isLoading ? "Loading..." :
                            <>
                                <p onClick={openPortal} className={"membershipLink"}>Change email</p>
                                <p onClick={openPortal} className={"membershipLink"}>Change password</p>
                            </>
                        }
                    </div>
                </div>
