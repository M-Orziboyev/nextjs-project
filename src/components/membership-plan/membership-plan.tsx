    ...
    return (
        <div
            ...
            <div className="space-y-2 py-4">
                ...
                <button
                    className='h-10 w-3.5 whitespace-nowrap bg-gray-300 py-2 text-sm font font-medium text-black shadow-md hover:bg-gray-200 md:w-4/5'>
                    Cancel Membership
                </button>
            </div>
            <div className="col-span-3 ">
                <div className="flex flex-col justify-between border-b border-white/10 py-4 md:flex-row">
                    <div>
                        <p className="font-medium">info@victo.ac</p>
                ...
                <div className=' flex flex-col justify-between pt-4 pb-4 md:flex-row md:pb-0'>
                    <div>
                        <p>Your membership will end 12 March 2024</p>
                    </div>
                    <div className="md:text-right">
