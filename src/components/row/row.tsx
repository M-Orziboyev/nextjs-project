        ...
        <>
            ...
            <div className="group relative mb-40">
                <AiFillCaretLeft
                    ...
                    className={`${!moved && 'hidden'} md:ml-2 absolute top-0 bottom-0 left-2 z-40 m-auto h-6 w-6 cursor-pointer fill-white group-hover:opacity-100 group sm:opacity-100 hover:scale-150 transition duration-200 shadow `}
                />
                <div
                    ref={carouseRef}
