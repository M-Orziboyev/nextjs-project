...
const Auth = () => {
    ...
    return (
        <div
            className='relative flex h-screen w-screen flex-col md:items-center md:justify-center bg-black md:bg-transparent'>
            <Head>
                <title>Auth</title>
                <meta
                    name="description"
            ...
            <Image
                ...
                alt={'bg'} fill className='object-cover -z-10 !hidden sm:!inline opacity-60'/>
            <Image
                src={"/logo.svg"}
                alt={"logo"}
                width={80}
                    ...
                    <Form>
                        ...
                        {auth === 'signin' ? (
                                <div className="text-[gray]">
                                    Not yet account? <button type="button" className="text-white  hover:underline"
                                                             onClick={() => toggleAuth('signup')}>Sign Up Now</button>
                                </div>

                            ) :
                            <div className="text-[gray]">
                                Already have account <button type="button" className="text-white mt-4 hover:underline"
