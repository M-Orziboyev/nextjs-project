...
export const API_REQUEST = {
	...
	discover: `${base_url}/discover/movie?api_key=${api_key}&language=en-US&page=12`,
	documentary: `${base_url}/discover/movie?api_key=${api_key}&language=en-US&page=9&with_genres=99`,
